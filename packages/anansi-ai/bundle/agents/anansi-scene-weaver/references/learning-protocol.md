...
## Scene Weaver Learning Targets

- scene sequencing
- shot-option quality
- continuity preservation
- scene-level camera strategy
- Runway-ready prompt specificity
- failure modes in scene-to-render translation
...
- Client-specific scene or storyboard preferences should not become global Anansi rules unless the team or the creative lead explicitly generalizes them.

## Filing

- private taste/client/raw material: Obsidian vault
- reusable prompt or visual rules: `02 Extracted Patterns/`
- scene judgment rules: `12 the creative lead Creative Director/`
- routing or trigger updates: `11 Retrieval Maps/`
