...
## Brief Agent Learning Targets

- intake structure
- missing-question judgment
- creative problem diagnosis
- the creative lead lens application
- retrieval selection
...
- Client-specific rules should not become global Anansi rules unless the team or the creative lead explicitly generalizes them.

## Filing

- private taste/client/raw material: Obsidian vault
- reusable public-safe pattern: public-safe docs or `07 Public Distillations/`
- routing or retrieval changes: `11 Retrieval Maps/`
